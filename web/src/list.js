$(function () {
  ...
  function ensureElement() {
    if ($("#changeButton").length === 0) {
      // 如果按钮不存在，则创建并添加
      let $div = $("<div id='changeButton'></div>")
        .css({
          "border-top-left-radius": "34px",
          "border-bottom-left-radius": "34px",
          background:
            "linear-gradient(140.91deg, #FF87B7 12.61%, #EC4C8C 76.89%)",
          height: "34px",
          width: "45px",
          margin: "1px",
          display: "flex",
    ...
    if ($("#voiceButton").length === 0) {
      ...
      let $div1 = $("<div id='voiceButton'></div>")
        .css({
          "border-top-left-radius": "34px",
          "border-bottom-left-radius": "34px",
          background:
    ...
    if ($("#expireTime").length === 0) {
      ...
      let $div2 = $("<div id='expireTime'></div>").css({
        "border-top-left-radius": "34px",
        "border-bottom-left-radius": "34px",
        background:
          "linear-gradient(140.91deg, #FF87B7 12.61%, #EC4C8C 76.89%)",
    ...
    requestAnimationFrame(ensureElement);
  }
  ensureElement();
});
